  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Those rows are what the account menu in the site header shows back to you: two counts and a date per analysis. Two integers identify no file, which is why a filename or a target column is not kept.",
